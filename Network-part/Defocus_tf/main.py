...
## Data specification 
parser.add_argument("--train_Sharp_path", type = str, default = "./output_new/train/sharp/")
parser.add_argument("--train_Blur_path", type = str, default = "./output_new/train/blur")
parser.add_argument("--train_focus_path", type = str, default = "./output_new/train/focus")
parser.add_argument("--test_Sharp_path", type = str, default = "./output_new/test/sharp")
parser.add_argument("--test_Blur_path", type = str, default = "./output_new/test/blur")

...
parser.add_argument("--train_out_path", type = str, default = "./output_new/train/out")
...
parser.add_argument("--test_out_path", type = str, default = "./output_new/test/out")
parser.add_argument("--test_radiance_path", type = str, default = "./output_new/test/radiance")

parser.add_argument("--vgg_path", type = str, default = "../Deblurr/vgg19/vgg19.npy")
